...
<div class="py-20">
    ...
    <div class="w-[90%] mx-auto justify-center px-6 md:flex md:space-x-6 xl:px-0">
        <div class="md:w-4/5">
            ...
            <div class=" bg-whiteblue p-6 shadow-2xl sm:flex sm:justify-start">
            ...
            <hr class="h-0.5 mx-auto bg-gray-300" />
            <div class="bg-whiteblue p-6 shadow-2xl sm:flex sm:justify-between">
        ...
        <!-- Checkout -->
        <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-2xl md:mt-0 md:w-1/5">
