...
@section('content')
    <img class="z-0 absolute top-0 left-0 w-screen -translate-y-24" src="{{ Storage::url('home/background.png') }}" alt="background image">
    <div class="w-[90%] m-auto">
        <div class="py-20 w-full flex justify-between items-center">
            <div class="flex flex-col z-10 gap-5 w-[55%]">
            ...
            <img class="w-[44%] z-10" src="{{ Storage::url('home/person.png') }}" alt="person image">
        </div>
    </div>
    ...
    <div class="w-[90%] mx-auto my-10">
        ...
        <div class="flex gap-7">
            <a class="w-[13%] h-[150px] hover:shadow-xl" href="/category">
            ...
            <a class="w-[13%] h-[150px] hover:shadow-xl" href="{{ route('category') }}">
